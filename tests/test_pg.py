...
from sqlbag import S, copy_url, raw_connection
from sqlbag.pg import pg_errorname_lookup, \
    errorcode_from_error, pg_notices, pg_print_notices, \
    use_pendulum_for_time_types

from sqlbag.pg.datetimes import UTC, vanilla, naive, ZERO, localnow, utcnow, parse_time_of_day, combine_date_and_time, sqlbagrelativedelta, parse_interval_values
...
def test_parse_interval():
    ...
    ANSWERS = [
        ...
        dict(years=-1, months=-2, days=3, hours=-4, minutes=5, seconds=6, microseconds=200000),
    ]
